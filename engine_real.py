...
def train_test_faketopo(model, train_subset, test_subset, train_loader, test_loader, optimizer, criterion, args):
    ...
    for epoch in range(args.epoch):
        ...
        with torch.no_grad():
            ...
            for i, (A, numericals, r_truth) in tqdm(enumerate(test_loader), total=len(test_subset) // args.test_size + 1):
